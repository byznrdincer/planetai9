...
export async function Masthead() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-paper/80 backdrop-blur-xl dark:border-d-line dark:bg-d-paper/80">
      <div className="mx-auto flex h-[68px] max-w-content items-center gap-6 px-5 sm:px-8">
        ...
        <nav className="hidden flex-1 items-center gap-0.5 overflow-x-auto text-[13.5px] font-medium lg:flex">
          {nav.map((it) => (
            <Link
              key={it.label}
              href={it.href}
