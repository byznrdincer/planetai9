.PHONY: help install lint fmt test check api ingest scheduler web migrate seed collect trends up down prod-up prod-down
...
prod-up: ## build + start the self-host production stack
